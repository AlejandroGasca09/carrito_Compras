...
function mostrarMenu() {
    ...
    menu += (productos.length + 2) + ". Agregar producto\n"
...
function aregarProductoLista(){
    var articuloNom = prompt("Ingresa el nombre del articulo : ")
    var articuloPre = prompt(parseFloat("Ingresa el precio del articuo : "))
    if (articuloNom && !isNaN(articuloPre)){
        productos.push({nombre:articuloNom,precio:articuloPre});
        console.log("El producto" + articuloNom + "Fue agregado con exito")
    }else{
        console.log("No se pudo agregar a la lista , intentalo de nuevo")
    }
}
